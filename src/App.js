...
function App() {
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      {/* Tecnologias */}
      <section className="p-6 sm:p-10 text-center bg-white">
      ...
      {/* Contato */}
      <section className="p-6 sm:p-10 text-center bg-gray-50">
      ...
      {/* Footer */}
      <footer className="bg-gray-800 text-white text-center py-4 text-xs sm:text-sm">
