...
const projects = [
  ...
  },
  {
    ...
    description:
      "Aplicação desktop multiplataforma em Python (PySide6) criada para facilitar a gestão financeira de igrejas. Permite o cadastro completo de membros e contribuintes, o registro estruturado de receitas (dízimos, ofertas, doações) e despesas (água, luz, aluguel, ministérios), bem como a geração de relatórios financeiros detalhados com exportação para PDF e Excel. O sistema inclui autenticação com níveis de acesso e uma interface moderna, pensada para auxiliar pastores e tesoureiros no controle administrativo.\n\nAlém dos recursos tradicionais, o software está evoluindo para incorporar módulos de Análise de Dados e BI, oferecendo dashboards de receita x despesa, gráficos de evolução mensal, identificação de categorias mais custosas e projeções financeiras baseadas em lançamentos recorrentes. Também contará com funcionalidades de IA/ML totalmente offline, como previsão de fluxo de caixa, detecção de anomalias e categorização inteligente de dados.\n\nOutro diferencial em desenvolvimento é o assistente conversacional offline, baseado em NLP utilizando Rasa, permitindo que usuários façam perguntas em linguagem natural (como consultar saldo, histórico de contribuições ou gerar relatórios) diretamente dentro do sistema, sem necessidade de internet.\n\nO projeto está em constante expansão, com foco em automações inteligentes, melhorias de usabilidade e integrações futuras (PIX, app para membros, contabilidade e muito mais).",
    link: "#",
    images: [
